...
nexta_live_tokenized <- create_tokenized("raw_data_csv/nexta_live.csv", "NEXTA Live")
  ...
  #Commenting out because keyATM didn't work as a topic modelling package. Couldn't get the data format the way it wanted. 
    ...
    #Instead, here I format from tidytext format into a document term matrics to use the topicmodels package. I followed instructions here: https://www.tidytextmining.com/nasa.html
...
```{r topicmodels}
#Continuing to follow instructions from here: https://www.tidytextmining.com/nasa.html

#Need to turn my tidytext into a document term matrix.
...
saveRDS(top_20, file = "gov50-final-shiny/clean_data/top_20.RDS")
...
saveRDS(gamma, "gov50-final-shiny/clean_data/gamma.RDS")
...
```{r keyATM topic modelling}
#this was a failure. I could not get my data in a format that it found acceptable, and couldn't follow their exact data processing step recommendations in quanteda because it would not work for my Russian/Belarussian text. 
